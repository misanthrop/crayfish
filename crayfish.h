...
enum
{
	...
	cf_del, cf_pause, cf_lcontrol, cf_rcontrol, cf_lshift, cf_rshift, cf_lalt, cf_ralt, cf_lsuper, cf_rsuper, cf_menu,
	cf_up, cf_down, cf_left, cf_right, cf_home, cf_end, cf_pageup, cf_pagedown, cf_insert, cf_separator,
	cf_capslock, cf_scrolllock, cf_numlock, cf_select, cf_print,
